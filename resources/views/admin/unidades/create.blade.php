...
@section('title', 'Nueva Unidad de Trabajo')
@section('page-title', 'Unidades de Trabajo')
@section('breadcrumb', 'Nueva Unidad')
        ...
        <div class="t-card">
            ...
            <div class="mb-4">
                <h5 style="color:var(--heading-color);font-weight:700;margin-bottom:.25rem">
                    <i class="fas fa-sitemap me-2" style="color:var(--accent)"></i>Nueva Unidad de Trabajo
                </h5>
                <p class="small mb-0" style="color:var(--muted-color)">Completá la descripción de la nueva unidad.</p>
            </div>
